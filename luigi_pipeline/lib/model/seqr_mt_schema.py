...
from luigi_pipeline.lib.model.mcri_seqr_mt_schema import SeqrGenetaleSchema, SeqrMcriStatsVariantSchema
...
class SeqrVariantsAndGenotypesSchema(SeqrGenetaleSchema, SeqrMcriStatsVariantSchema, SeqrVariantSchema, SeqrGenotypesSchema):
    """
