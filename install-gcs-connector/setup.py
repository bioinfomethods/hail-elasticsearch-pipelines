...
GCS_CONNECTOR_URL = 'https://repo1.maven.org/maven2/com/google/cloud/bigdataoss/gcs-connector/hadoop2-2.2.9/gcs-connector-hadoop2-2.2.9-shaded.jar'
...
setup(
    ...
    url='https://github.com/bioinfomethods/seqr-loading-pipelines',
    author='MCRI Bioinfomethods Group',
    author_email='archie@mcri.edu.au',
    packages=['install-gcs-connector'],
    install_requires=['hail'],
    version='0.1',
    license='MIT',
    description='Installs Google Cloud Storage connector for Hadoop',
    cmdclass={
